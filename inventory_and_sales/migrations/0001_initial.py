# Generated by Django 3.0.6 on 2020-05-31 15:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Datetime', models.DateTimeField(default=datetime.datetime(2020, 5, 31, 21, 9, 59, 976615), help_text='Date and time when order was placed', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventory_and_sales.Product')),
            ],
        ),
    ]
